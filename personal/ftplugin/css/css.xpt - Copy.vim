...
XSET $scroll=scroll
XSET $fixed=fixed
background-attachment: `Snippet("_chooseXSET")^;
...
XSET $text=text
background-clip: `Snippet("_chooseXSET")^;
...
background-origin: `Snippet("_chooseXSET")^;
...
background-position: `Snippet("_chooseXSET")^;
...
background-repeat: `Snippet("_chooseXSET")^;
...
background-size: `Snippet("_chooseXSET")^;
...
border-collapse: `Snippet("_chooseXSET")^;
...
font-size: `Snippet("_chooseXSET")^;
XPT font_size_adjust setting=_chooseXSET " font size adjust
XSET $none=none
XSET $inherit=inherit
XSET $`number^=`number^
font-size-adjust: `Snippet("_chooseXSET")^
...
XSET $900=900
XSET $inherit=inherit
font-weight: `Snippet("_chooseXSET")^;
...
white-space: `Snippet("_chooseXSET")^;
