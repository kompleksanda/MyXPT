...
set cpo-=< cpo+=B
fun! xpt#ftscope#New()
	let inst = { 'filetype':'', 'allTemplates':{}, 'ftkeyword':{ 'regexp' : '\w', 'list' : [] }, 'funcs':{ '$CURSOR_PH' : 'CURSOR' }, 'inited':0, 'varPriority':{}, 'loadedSnipFiles':{}, 'extensionTable':{}, 'snipPieces':[], 'setting':{'defaultValues':{},'preValues':{},'postFilters':{}}}
	return inst
endfunction
